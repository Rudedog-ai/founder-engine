  ...
  return (
    <div className="screen-content">
      ...
      <div className="card" style={{ background: 'var(--surface)' }}>
        ...
        {/* Step 1: Save your WhatsApp number */}
        <form onSubmit={handleSavePhone} style={{ display: 'flex', gap: '8px', alignItems: 'flex-end', marginBottom: '16px' }}>
          <div style={{ flex: 1 }}>
        ...
        <div style={{ padding: '12px 14px', background: 'var(--abyss)', borderRadius: 'var(--radius-sm)', border: '1px solid var(--sea)' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <div>
              <div style={{ fontSize: '1.1rem', fontWeight: 600, color: 'var(--glow)', letterSpacing: '0.5px' }}>
                +1 415 523 8886
              </div>
              <div style={{ fontSize: '0.75rem', color: 'var(--text-dim)' }}>
                Open the WhatsApp chat and tap the phone icon to call
              </div>
            </div>
          </div>
        </div>
