          ...
          <div className="ocean-form-card">
            {!showEmailForm ? (
              <>
                ...
                <button className="btn btn-primary btn-block" onClick={handleGoogle} type="button" disabled={loading} style={{ marginBottom: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', padding: '14px 20px', fontSize: '1rem' }}>
                  ...
                  {loading ? <><span className="spinner" style={{ width: 16, height: 16 }} /> Connecting...</> : 'Continue with Google'}
                </button>
